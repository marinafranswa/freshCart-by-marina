  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6">
      ...
      {prod.priceAfterDiscount ? (
        <div className="flex items-center flex-wrap gap-3 mb-6">
          ...
          <span className="bg-red-500 text-white text-sm px-3 py-1 rounded-full font-medium">
            Save
            {Math.floor(
              ((prod.price - prod.priceAfterDiscount) /
                prod.price) *
                100,
            )}
            %
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center border-2 border-gray-200 rounded-lg overflow-hidden">
            <button className="px-4 py-3 text-gray-600 hover:bg-gray-100 hover:text-primary-600 transition disabled:opacity-50">
              <Minus size={12} />
            </button>
            <input
              min={1}
      ...
      <div className="flex gap-3 mb-6">
        ...
        <button className="border-2 border-gray-200 text-gray-700 py-3 px-4 rounded-xl hover:border-green-300 hover:text-green-600 transition">
          <Share2Icon />
        </button>
      </div>
