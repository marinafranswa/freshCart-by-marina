      ...
      <CardContent className="p-0">
        <div className="flex items-start gap-4 p-6 pb-4">
          ...
          <div className="flex-1 min-w-0">
            <Badge className={`bg-yellow-200 text-amber-700 border-0 gap-1.5 mb-2 font-semibold`}>
              <span className={`w-1.5 h-1.5 rounded-full}`} />
            <Clock/>  {order.isDelivered}
            </Badge>
        ...
        <div className="flex items-center justify-between px-6 pb-5">
          ...
          {expanded ? (
            ...
            <Button
              ...
              variant="outline"
              className="rounded-lg gap-2 text-gray-700"
            >
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-400 mt-0.5">
                        {item.product.quantity} × {item.price} EGP
                      </p>
                    </div>
                    <div className="text-right shrink-0">
                      <p className="text-base font-bold text-gray-900">
                        {item.product.quantity * item.price}
                      </p>
              ...
              <div className="bg-yellow-50 rounded-xl border border-yellow-200 p-4">
                ...
                <div className="space-y-2 text-sm text-gray-500">
                  <div className="flex justify-between">
                    <span>Subtotal</span>
                    <span className="text-gray-700">{order.subtotal} EGP</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Shipping</span>
