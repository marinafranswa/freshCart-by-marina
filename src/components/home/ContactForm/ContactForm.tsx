...
import { ArrowRight, Leaf, Mail, Sparkles, Tag, Truck } from "lucide-react";
              ...
              <div className="lg:col-span-3 space-y-6">
                ...
                <form className="pt-2">
                  ...
                  <p className="text-xs text-gray-400 mt-3 pl-1">
                    <Sparkles
                      size={12}
                      className="fill-amber-300 text-amber-400 inline-block"
                    />{" "}
